 export const text={
    ...
    D1: {
        text: `Luchar`,
        postD:`No te permitiras morir cuando tan solo has dado el primer paso, sabes que no estas aqui para ser cuidado, no despues de haber abandonado a tanta gente con tal de salvarte.
