 export const text={
  ...
  Lo haces por la persona que está siendo sujetada, vez como su cuerpo está roto en mucha formas, sus extremidades cuelgan como una marioneta a la que se le cortaron los hilos, su rostro está deformado por tanto castigo que recibió por parte de aquel ser, cualquier pensamiento de lucha a abandonado su cabeza y solo hay una terrible resignación, incluso tu lo sabes, no hay salvación, aun así.`,
      ],
    D1: {
        text: `Matar`,
        postD:`Desde un comienzo sabes que no eres normal, incluso entre los que están por aquí, tu percepción de la realidad está distorsionada, al caminar por ese mar de llamas no solo causó la pérdida de tu vida, ese fuego devoró mucho más que sólo personas.`
    },
