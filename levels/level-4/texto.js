export const text = {
  ...
  D1: {
    text: `Llevar`,
    postD: `La codicia es algo que no logras comprender, tu alma no tiene ese sentido ya que terminó por ser abandonado, lo que sí sabes es que necesitas algo para defenderte, hasta ahora no te has topado con grandes desafíos, solo con reflexiones, decides llevarte la lanza como una forma de protección.
  ...
  D2: {
    text: `Dejar`,
    postD: `Dejas de lado la lanza que has levantado, hasta ahora no has tenido la necesidad de usar algún tipo de arma, por lo que es innecesario para ti llevártela.
  ...
  finalText: `Ingresas en la cueva que te llevará al siguiente círculo.`,
};
