 export const text={
    ...
    D1: {
        ...
        postD:`Avanzar es lo unico que puedes hacer, incluso si te quedas aqui, no habria nada que hacer mas que solo lamentar tu existencia, entonces con el dolor en tu alma, con el ardor en tu cuerpo desgastado, sigues adelante abandonando tus dudas.`
    },
    
    D2: {
        text: `Rendirse`,
        postD:`Una existencia vacia sin un proposito, eso es lo que eres, no importa cuanto quieras negarlo, entonces solo te queda estar varado en este lugar donde la nada sera tu unico acompañante, en verdad que desperdicio de existencia`
    },
    finalText:`Aunque tú mismo sabes que es falso, siempre tendrás dudas sobre tu existencia, dudas del porque sigues aqui mientras que otros no, pero eso no quiere decir que no puedas seguir avanzando por este camino que has elegido recorrer, la pregunta será, ¿podrás llegar hasta el final?`
