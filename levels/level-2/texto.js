 export const text={
    ...
    D1: {
        text: `Caer`,
        postD:`A pesar de reflexionar sobre lo que has visto, una parte de tu alma aún anhelante de afecto físico, decide que a pesar de sufrir de aquel castigo, después de todo, estar solo es un castigo aún peor.
    ...
    D2: {
        text: `Rechazar`,
        postD:`Sujetando con fuerza aquel crucifijo que cuelga de tu cuello, té armas de valor para seguir adelante, usándolo como un amuleto para calmar tus deseos más primarios que quieren resurgir de tu alma.
    ...
    finalText:`Al abandonar cualquier tipo de deseo carnal, sigues tu camino atravesando aquellos fuertes vientos que azotan tu carne suave, sientes como la carne quiere desprenderse de tu cuerpo, pero sigues adelante ignorando cualquier tipo de sonido, tus ojos arden cuanto más avanzas por el viento que aumentó la fuerza de sus corrientes, aun asi sigues ignorando cualquier tipo de dolor.
